...
const envSchema = z.object({
  ...
  STRIPE_PRICE_PROFESSIONAL_YEARLY: z.string().default("price_placeholder"),
  STRIPE_PRICE_CORPORATION_MONTHLY: z.string().default("price_placeholder"),
  STRIPE_PRICE_CORPORATION_YEARLY: z.string().default("price_placeholder"),
  STRIPE_PRICE_FORENSIC_AUDITOR_MONTHLY: z.string().default("price_placeholder"),
  STRIPE_PRICE_FORENSIC_AUDITOR_YEARLY: z.string().default("price_placeholder"),
